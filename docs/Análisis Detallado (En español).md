...
- No hay ventas que sean consideradas atipicas, todos los puntos (las ventas por generos) están dentro de los limites del boxplot. Es decir, que aunque hubieron ventas muy altas (Action: 1722.48 M), son consideradas como ventas que están dentro de la variabilidad esperada.
...
- Hay 6 puntos fuera de los bigotes del boxplot, estos valores atipicos (1233.46 M, 969.61 M, etc) son ventas que fueron un gran exito y rompieron el mercado. Son ventas que superan por
...
Tras examinar más de **8800** millones de unidades vendidas y analizar múltiples perspectivas (regional, temporal, por género y plataforma), destacamos:
